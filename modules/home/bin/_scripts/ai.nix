{
  ...
  examples = [
    ...
    {
      cmd = "cat file | ai 'summarize'";
      desc = "Pipe input as context";
    }
    {
      cmd = "ai -r 'tell me more'";
      desc = "Continue last conversation";
    }
    {
      cmd = "ai -c 'write a haiku'";
      desc = "Copy result to clipboard";
    }
    {
      cmd = "ai --raw 'list files'";
      desc = "Plain text, no markdown";
    }
  ];
  fish = ''
