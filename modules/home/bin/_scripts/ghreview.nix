{
  ...
  examples = [
    {
      cmd = "ghreview";
      desc = "View reviews for current PR";
    }
    {
      cmd = "ghreview --pretty";
      desc = "Pretty-print as markdown";
    }
    {
      cmd = "ghreview --raw";
      desc = "Raw JSON output";
    }
    {
      cmd = "ghreview --no-code";
      desc = "Skip source code context";
    }
    {
      cmd = "ghreview threads list";
