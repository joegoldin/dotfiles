{
  ...
  desc = "Add PyPI packages to the custom python set (resolves deps, pins hashes)";
  usage = "setup-python-packages <pkg>[==version] [...]";
  examples = [
    {
      cmd = "setup-python-packages fal-client";
      desc = "Add fal-client at its latest version";
    }
  ];
  hostOnly = true;
  bash = ''
    ...
    FULL_PKG_PATH="$DOTFILES/$PKG_FILE"
    DEFAULT_NIX_PATH="$DOTFILES/modules/home/_python/default.nix"
