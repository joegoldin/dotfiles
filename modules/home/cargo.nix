# NOTE: not included by any host (parity with the old tree, where nothing
# imported it). Include den.aspects.cargo somewhere to activate.
{ ... }:
{
  den.aspects.cargo.homeManager =
    {
      pkgs,
      ...
    }:
