  ...
  den.aspects.microvm-host.nixos =
    ...
    in
    {
      ...
      system.activationScripts.microvmBuiltinProfiles = ''
        ...
        install -m 0644 ${../_data/microvm/profiles/desktop.json} /var/lib/vm-specs/profiles/desktop.json
        install -m 0644 ${../_data/microvm/profiles/minimal.json} /var/lib/vm-specs/profiles/minimal.json
      ...
      environment.systemPackages =
        let
          ...
          vmModuleGen = pkgs.writeShellScriptBin "vm-module-gen" ''
            exec ${pkgs.python3}/bin/python3 ${../_data/microvm/module-gen.py} "$@"
          '';
        in
        with pkgs;
        [
