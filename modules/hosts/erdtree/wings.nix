...
# fronts it on this node's direct FQDN (erdtree.turnin.quest → :443 → Wings :8080).
...
#
# After deploy: create the node in the panel (FQDN erdtree.turnin.quest, SSL on,
...
in
{
  den.aspects.erdtree.nixos =
    ...
    in
    {
      ...
      services.caddy.virtualHosts."${domains.erdtreeSshDomain}" = {
        extraConfig = ''
