# Siofra — 16 GB misc-cloud VPS (107.174.45.13) with its own standalone Pelican
# Panel + Wings. Entity name (= flake output) and hostName are both "siofra".
# Installed via nixos-anywhere; lean home like racknerd. Aspect content lives in
# the sibling files (system.nix, machine.nix, pelican.nix, home.nix).
{ inputs, den, ... }:
let
