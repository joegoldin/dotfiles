# Joes-MacBook-Pro (aarch64-darwin). Bridged den entity: legacy module tree
# under hosts/darwin imported as-is, specialArgs injected via instantiate +
...
let
  ...
  specialArgs = (import ../_lib/legacy-args.nix { inherit inputs; }) // {
    ...
    homeDirectory = inputs.nixpkgs.lib.mkForce "/Users/${meta.username}";
  };
in
{
